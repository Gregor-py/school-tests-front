...
const DeleteAnswerButton: FC<DeleteAnswerButton> = ({ answerId, taskId, refetchTask }) => {
	const { mutate: deleteAnswer, isSuccess } = useMutation(['delete answer from task', answerId], (data: { answerId: string, taskId: string }) => EditTaskService.deleteAnswer(data.answerId, data.taskId))
