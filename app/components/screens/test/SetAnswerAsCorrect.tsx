...
const SetAnswerAsCorrect: FC<SetAnswerAsCorrect> = ({ isCorrect, answerId, taskId, refetchTask, setCorrectAnswerId }) => {
	const { mutate: setCorrectAnswer, isSuccess } = useMutation(['set correct answer to task', answerId], (data: { taskId: string, newCorrectAnswerId: string }) => EditTaskService.changeCorrectAnswer(data.taskId, data.newCorrectAnswerId))
	...
	return (
		...
		<button onClick={handleClick}>
			<div className={classNames(styles.decor)}>
				<div className={classNames(styles.svgContainer, { 'opacity-0': !isCorrect })}>
